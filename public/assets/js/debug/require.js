...
function(mynamespace, Backbone) {

  // Create a new module
  var Example = mynamespace.module();
  ...
  Example.Views.Tutorial = Backbone.View.extend({
    ...
    render: function(done) {
      ...
      mynamespace.fetchTemplate(this.template, function(tmpl) {
...
function(mynamespace, $, Backbone, Example) {
